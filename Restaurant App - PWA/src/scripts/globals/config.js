const CONFIG = {
	...
	BASE_IMAGE_URL: 'https://restaurant-api.dicoding.dev/images/small/',
  	...
  	CACHE_IMAGE_NAME: 'GOLEKMANGAN-IMG-CACHE',
	CACHE_NAME: `GOLEKMANGAN-CACHE`,
	CACHE_API_NAME: 'DICODING-API-CACHE',
	OBJECT_STORE_NAME: 'GOLEKMANGAN',
	DB_NAME: 'GOLEKMANGAN-RESTO-DB',
	DB_VERSION: 1,
};
